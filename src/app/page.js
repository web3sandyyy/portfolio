    ...
    <div className='main text-white '>
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="px-[10vw] py-16 glass-copy rounded-xl flex flex-col lg:flex-row gap-4 items-center text-center md:text-left mx-4 w-4/5  lg:w-[70%] justify-around">
          <div className=" text-2xl md:text-3xl lg:text-4xl text-center font-semibold ">Hi! < span className="text-3xl md:text-4xl lg:text-5xl text-purple-700" >Im Sandeep,</span ><br/><p className="whitespace-nowrap mt-2"> A Blockchain Developer</p></div>
          <Image src={profile} alt="profile"  className="rounded-full h-[12em] w-[12em] md:h-[14em] md:w-[14em] object-scale-down  profile"/>
        </div>
      </div>
