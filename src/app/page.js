  ...
  return (
    <div className="bg text-white ">
      <Head>
        ...
        <meta name="description" content="A Passionate Blockchain Developer." />
        <meta property="og:title" content="Sandeep's Portfolio" />
        <meta property="og:description" content="A Passionate Blockchain Developer." />
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="px-[10vw] py-16 glass-copy rounded-xl flex flex-col lg:flex-row gap-4 items-center text-center md:text-left mx-4 w-4/5  lg:w-[70%] justify-around intro">
