...
export default function Navbar() {
  ...
  const liCSS =
    "px-2 border-r-2 border-white hover:italic hover:rounded-lg ease-in-out duration-300 translate-x-0 hover:translate-x-1";
  const sidenav =
    "text-center py-6 mx-4 border-b-2 hover:italic hover:rounded-xl ease-in-out duration-300 ";
  const toggleMenu = () => {
    setShow(!show);
    console.log("clicked");
  };
  ...
  return (
    <>
      ...
      {show && (
        <div className="border-s-2 h-screen w-3/5 fixed right-0 top-0 md:hidden rounded-xl z-[20]">
